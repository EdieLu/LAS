...
set LOG=$1
set TRAIN=/home/alta/BLTSpeaking/exp-ytl28/encdec/acous-las-run-v3/train.sh
# set TRAIN=/home/alta/BLTSpeaking/exp-ytl28/encdec/acous-las-run-v3/train-combine.sh
